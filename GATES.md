...
- [x] G1: HTTP authorization, routing and LAN scope are exercised by regression tests
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/zhuangzheyun/claudeai知識庫/VIBE_開發專案/ScreenTaskMac; path=8d877d837201/38 entries; EXPECT=matched; output-sha256=51ab2e7e7d20872761fa215bc2933e493161019301be07f3f0d95e04853fb814; output-bytes=191
...
- [ ] G5: Public GitHub repository and downloadable release are reachable
  EVIDENCE: pending
